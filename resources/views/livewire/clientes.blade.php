<div>    
    <hr id="clientes" class="border-solid border-2 border-light-blue-500 mt-10  md:mt-20"> 
    
    <span id="ClientesImg"></span>


    <div  id="ClientesDesc" class="mx-auto container hidden">
        <h1 class="text-4xl md:text-5xl text-center mt-20 mb-12">{{trans('multi-leng.clientes')}}</h1>
    </div>


    <div id="ClientesText" class="hidden">
      <div class="slideshow-container">      
          <div class="mySlides fade">
              <div class="numbertext">1 / 3</div>
              <img  class="w-96 h-96" src="https://cdn.pixabay.com/photo/2016/01/19/15/05/doctor-1149149_960_720.jpg" style="width:100%">
            ...
            <div class="mySlides fade">
              ...
              <img class="w-96 h-96"  src="https://cdn.pixabay.com/photo/2014/08/26/21/54/dentist-428646_960_720.jpg" style="width:100%">
            ...
            <div class="mySlides fade">
              ...
              <img class="w-96 h-96"  src="https://cdn.pixabay.com/photo/2014/12/10/21/01/doctor-563429_960_720.jpg" style="width:100%">
            ...
            <div class="mySlides fade">
                <div class="numbertext">3 / 3</div>
                <img src="  https://cdn.pixabay.com/photo/2014/08/26/21/53/dentist-428645_960_720.jpg" style="width:100%">
