<div>
    ...
    <hr id="acercaDe" class="border-solid border-2 border-light-blue-500 mt-10 md:mt-20"> 
    
    
    <div class="container mx-auto grid grid-cols-1 sm:grid-cols-2 gap-1 mt-10 md:mt-36">
        <img class="float-right" src="{{asset('imgs/acerca.jpg')}}" alt="">
        <span class=" px-5 text-justify text-xl"><br>
            <h1 class="text-4xl md:text-5xl text-center mb-12">{{trans('multi-leng.acerca-de')}}</h1>
            ...
            <br>
            <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum, animi dolores! Ipsum pariatur illo aut ut quam asperiores vel ex quibusdam ad deleniti, omnis sunt mollitia placeat amet enim repudiandae.
            </p>
        </span>
    </div>
