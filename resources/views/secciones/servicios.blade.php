...
@extends('secciones.plantilla')

@section('title', 'Servicios')

@section('titulo')
    <h1 class="text-5xl text-center mt-10">{{trans('multi-leng.servicios')}}</h1>
@endsection
    
@section('content')

<div class="container mx-auto  mt-10 px-5 text-justify text-xl">                  
    ...
    <div class="pb-7 w-72 mx-auto">  
        <div class="h-16 ">  
            ...
            <div class="servicio-desc h-72">
                ...
                <img src="{{asset('imgs/icons/servicios/ORTODONCIA.jpg')}}" alt="" class="w-full">
    ...
    <div class="pb-7 w-72 mx-auto">   
        <div class="h-16 ">  
            ...
            <div class="servicio-desc h-72">
                ...
                <img src="{{asset('imgs/icons/servicios/IMPLANTES.jpg')}}" alt="" class="w-full">
                <div class="sidebar-box "> 
                <p class="text-justify hidden ">
                    @if (trans('multi-leng.idioma') == 'espanol')      
    ...
    <div class="pb-7 w-72 mx-auto">  
        <div class="h-16">  
            ...
            <div class="servicio-desc h-72">
                ...
                <img src="{{asset('imgs/icons/servicios/TEMPOROMANDIBULAR.jpg')}}" alt="" class="w-full">
                <div class="sidebar-box "> 
                <p class="text-justify hidden ">
                    @if (trans('multi-leng.idioma') == 'espanol')      
    ...
    <div class="pb-7 w-72 mx-auto">   
        <div class="h-16">    
            ...
            <div class="servicio-desc h-72">
                ...
                <img src="{{asset('imgs/icons/servicios/ENDODONCIA.jpg')}}" alt="" class="w-full">
                <div class="sidebar-box "> 
                <p class="text-justify hidden ">
                    @if (trans('multi-leng.idioma') == 'espanol')      
    ...
    <div class="pb-7 w-72 mx-auto">   
        <div class="h-16">    
            ...
            <div class="servicio-desc h-72">
                ...
                <img src="{{asset('imgs/icons/servicios/ODONTOPEDIATRICA.jpg')}}" alt="" class="w-full">
                <div class="sidebar-box "> 
                <p class="text-justify hidden ">
                    @if (trans('multi-leng.idioma') == 'espanol')      
    ...
    <div class="pb-7 w-72 mx-auto">  
        <div class="h-16">    
            ...
            <div class="servicio-desc h-72">
                ...
                <img src="{{asset('imgs/icons/servicios/ODONTOESTETICA.jpg')}}" alt="" class="w-full">
                <div class="sidebar-box "> 
                <p class="text-justify hidden ">
                    @if (trans('multi-leng.idioma') == 'espanol')      
